...
// NOTE: /jobs is PUBLIC (anyone can browse the job listings). Only APPLYING —
// the interview flow under /jobs/<id>/interview and /interview/<slug> — needs
// a login. That keeps the top of the funnel open to visitors.
const PROTECTED_PREFIXES = ['/profile', '/company', '/interview', '/admin', '/dashboard']

// Specific sub-paths that require login even though their parent is public.
const PROTECTED_PATTERNS = [/^\/jobs\/[^/]+\/interview/]
