      ...
      <div className="container mx-auto max-w-md">
        ...
        <form onSubmit={onSubmit} className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-xl shadow-indigo-500/5 space-y-5">
          ...
          <p className="text-center text-xs text-slate-400 pt-2">
            New company?{' '}
            <Link href="/signup/company" className="font-black text-indigo-600 hover:text-indigo-500">
              Create company account
            </Link>
            <span className="text-slate-300"> · </span>
            Candidate?{' '}
            <Link href="/login" className="font-black text-indigo-600 hover:text-indigo-500">
              Candidate login
            </Link>
          </p>
        </form>
