...
export default function LandingPage() {
  ...
  return (
    <div className="bg-transparent min-h-screen pb-24">
      ...
      <section className="relative pt-48 pb-32 z-10 text-slate-900 overflow-hidden min-h-[100vh] flex items-center">
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-2xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-600 text-[10px] font-black mb-10 animate-fade-in uppercase tracking-[0.4em]">
              JobStream Platform
            </div>
      ...
      <section className="py-32 z-10 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-white to-indigo-50 border border-slate-200 rounded-[4rem] p-12 md:p-20 shadow-2xl shadow-indigo-500/5 relative overflow-hidden group">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-black text-slate-800 uppercase tracking-widest text-xs">Precise CV Scanning</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600">
                        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                      </div>
                      <span className="font-black text-slate-800 uppercase tracking-widest text-xs">Instant Recommendations</span>
                    </div>
                  </div>
                </div>

                <div className="bg-white border border-slate-200 p-10 rounded-[3rem] shadow-xl relative group-hover:scale-[1.02] transition-transform duration-500">
      ...
      <section className="py-32 z-10 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="relative">
            <p className="text-center text-slate-500 font-black uppercase tracking-[0.4em] text-[10px] mb-12">Integrated with Global Leaders</p>
              ...
              <div className="animate-marquee flex items-center gap-24 whitespace-nowrap">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="flex gap-32 items-center opacity-40 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                    ...
                    <span className="text-4xl font-black tracking-tighter text-slate-900">micro1</span>
                    <span className="text-3xl font-black tracking-tighter text-slate-900 flex items-center">
                    ...
                    <span className="text-3xl font-black tracking-tighter text-slate-900">glassdoor</span>
                    <span className="text-3xl font-black tracking-tighter text-slate-900">indeed</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-32 z-10 relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-blue-50 mx-4 md:mx-10 rounded-[5rem] shadow-2xl border border-slate-200">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-24">
              <span className="inline-block px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-600 font-black text-[10px] uppercase tracking-[0.5em] mb-6">THE VISION</span>
              <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter uppercase leading-[0.9] mb-8">
                STOP SETTLING <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
              {[
                ...
                <div key={i} className="bg-white border border-slate-200 p-10 rounded-[3rem] text-center shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 transition-all hover:-translate-y-2 group">
                  <span className="text-3xl font-black text-slate-900 uppercase tracking-tighter mb-4 block group-hover:text-indigo-600 transition-colors">{item.title}</span>
                  <p className="text-slate-500 text-sm font-medium">{item.text}</p>
                </div>
              ))}
            </div>
            <div className="max-w-3xl mx-auto bg-white border border-slate-200 p-12 rounded-[4rem] text-center shadow-sm">
              <p className="text-xl md:text-2xl text-slate-700 leading-relaxed font-medium mb-8">
                ...
                JobStream connects you with opportunities that see <span className="text-slate-900 font-black underline decoration-indigo-500 decoration-4 underline-offset-8">YOUR</span> real potential.
              </p>
              <div className="pt-8 border-t border-slate-200">
                <p className="text-2xl md:text-4xl text-slate-900 font-black tracking-tight uppercase leading-tight">
                  Not just your resume. <br />
                  <span className="text-indigo-600">You. As a whole.</span>
                </p>
              </div>
            </div>
          </div>
