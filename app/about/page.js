    ...
    <div className="bg-transparent min-h-screen pt-32 pb-24">
      ...
      <section className="relative py-24 z-10 text-center">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-12 tracking-tighter leading-tight uppercase animate-fade-in">
            A Story of <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
              Agentic Discovery
            </span>
          </h1>
          <div className="max-w-3xl mx-auto space-y-8 text-slate-400 text-lg md:text-xl leading-relaxed font-medium animate-fade-in">
            <p>
      ...
      <section className="py-32 z-10 bg-gradient-to-br from-slate-900/5 to-blue-500/5 rounded-[5rem] mx-4 md:mx-10 border border-white/20 shadow-2xl backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-24">
            <span className="text-blue-500 font-black text-[10px] uppercase tracking-[0.5em] mb-6 block">Our Impact</span>
            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter uppercase leading-none">The Liftoff <br/> Equation</h2>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-20 perspective-1000">
            ...
            <div className="group relative flex flex-col items-center">
              <div 
                className="w-32 bg-slate-800 border border-slate-700 rounded-2xl relative preserve-3d transition-all duration-700 group-hover:rotate-y-12 group-hover:-rotate-x-12 shadow-xl"
                style={{ height: '300px' }}
              >
                {/* Glow Core */}
              ...
              <p className="mt-8 text-white font-black text-xs uppercase tracking-[0.3em]">Applications</p>
            </div>
            ...
            <div className="group relative flex flex-col items-center">
              ...
              >
                ...
                {/* Success Core */}
                <div className="absolute inset-x-4 bottom-0 bg-slate-900/20 rounded-t-xl transition-all duration-1000 h-[40%] group-hover:h-[45%]"></div>
                {/* 3D Label */}
                <div className="absolute -top-12 left-0 right-0 text-center font-black text-white text-3xl drop-shadow-xl">12k+</div>
              </div>
              <p className="mt-8 text-white font-black text-xs uppercase tracking-[0.3em]">Hired</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-40 z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-24">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tighter uppercase">What the Galaxy Says</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={i} className="bg-slate-900/10 border border-white/20 p-12 rounded-[3rem] transition-all hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-3 group relative overflow-hidden">
                ...
                <p className="text-slate-300 font-medium italic mb-10 text-lg leading-relaxed">"{t.text}"</p>
                <div>
      ...
      <section className="py-24 z-10 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-12 tracking-tighter uppercase">Write your own Story</h2>
