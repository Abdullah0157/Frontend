    ...
    <div className="min-h-screen pt-32 pb-24 px-4">
      <div className="container mx-auto max-w-5xl">
        <div className="flex items-center justify-between mb-8">
          <Link href="/company" className="text-xs font-black uppercase tracking-widest text-indigo-400 hover:text-indigo-300">
            ← Back to dashboard
          </Link>
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight uppercase text-white">
            Browse <span className="text-indigo-400">Candidates</span>
          </h1>
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full px-5 py-4 rounded-2xl border border-slate-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 outline-none transition"
          />
        </div>
          ...
          <div className="grid gap-3">
            {filtered.map((c) => (
              <Link
                ...
                className="bg-slate-900 border border-slate-800 hover:border-indigo-700 rounded-[1.5rem] p-5 transition-all flex items-center justify-between gap-6 group"
              >
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-black text-white truncate group-hover:text-indigo-300 transition-colors">
                      {c.full_name || '(no name)'}
                    </h3>
                ...
                <div className="flex items-center gap-8 text-right flex-shrink-0">
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Interviews</p>
                    <p className="text-xl font-black text-white">{c.interview_count || 0}</p>
                  </div>
                  <div>
                  ...
                  <span className="text-slate-500 group-hover:text-indigo-300 transition-colors">→</span>
                </div>
              </Link>
            ))}
          </div>
